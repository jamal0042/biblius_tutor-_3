    ...
    return (
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Bonjour, Jamal</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard title="Emprunts en cours" value="3" icon={BookOpen} color="blue" />
            <StatCard title="En retard" value="1" icon={AlertCircle} color="red" />
            <StatCard title="Reservations" value="2" icon={Calendar} color="amber" />
            <StatCard title="Amendes impayees" value="0 FCFA" icon={CheckCircle} color="green" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Mes reservations</h2>
            <div className="space-y-3">
