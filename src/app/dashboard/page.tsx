  import { BookOpen, Calendar, AlertCircle, CheckCircle2, Clock, ArrowRight, Sparkles, Library, TrendingUp } from "lucide-react"
  ...
  import {
    ...
    buildMonthlyFlow,
    type FlowPoint,
  } from "@/components/dashboard/horizontal-flow-chart"
  ...
  /* =========================================================
  COURBE DE FLUX (lignes) — utilise le FlowPoint importé
  ========================================================= */
  ...
  export default async function DashboardPage() {
    ...
    // Historique complet pour les graphiques de flux
    ...
    // 🌟 Flux construits via la fonction partagée (type FlowPoint correct)
    const flow = buildMonthlyFlow(
      (allLoans as { loan_date: string }[]) || [],
      (allReturns as { return_date: string }[]) || []
    )
            ...
            <Card className="border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
              <CardContent className="p-5 sm:p-6">
                <div className="mb-6 flex items-center justify-between">
                  ...
                  <Badge variant="outline" className="border-sky-300 text-sky-600 dark:border-sky-700 dark:text-sky-400">
                    {flow.reduce((s, f) => s + f.loans, 0)} emprunts
                  </Badge>
                </div>
                <HorizontalFlowChart data={flow} />
              </CardContent>
            </Card>
